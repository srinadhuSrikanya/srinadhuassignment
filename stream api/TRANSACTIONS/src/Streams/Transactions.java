...
public class Transactions {
	...
	public static void main(String[] args) {
		...
		List<Transactions> list=Arrays.asList(
				new Transactions(new Trader("Srikanya", "Pune"), 2011, 5000),
				new Transactions(new Trader("Rahul", "Bangalore"), 2012, 4000),
				new Transactions(new Trader("kalyan", "Pune"), 2011, 3000),
				new Transactions(new Trader("gayi", "Delhi"), 2012, 2000)
				);
